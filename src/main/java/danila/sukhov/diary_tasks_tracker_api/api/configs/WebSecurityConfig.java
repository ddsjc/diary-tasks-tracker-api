    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/project/**", "/projects/**", "task-state/**", "task/create/**").hasAuthority("ADMIN") // Только для админов
                        .requestMatchers("/task/**").hasAuthority("EXECUTOR")// Доступ для эндпоинтов аутентификации
